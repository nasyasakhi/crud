  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p class="text-center">Yakin mau hapus data? <strong style="color: red;">{{$row->nama_buah}}</strong></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
        <a href="{{route('buah.destroy', $row->id)}}" class="btn btn-primary">Delete</a>
      </div>
    </div>
  </div>
</div>
    ...
    <a href="{{ route('buah.create') }}" class="btn btn-warning">Tambah</a>
